...
namespace XS.Blog.Data
{
    ...
    public interface IAlbum
    {
        ...
        /// </summary>
        AlbumInfo GetModel(string guid);
        ...
        List<AlbumInfo> GetList(string strWhere, string orderBy = null);
        ...
        List<AlbumInfo> GetList(int currentPageIndex, int pageSize, out int totalCount, string strWhere, string orderBy);
