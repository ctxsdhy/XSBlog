...
namespace XS.Blog.Data
{
    public interface IMood
    {
        ...
        List<MoodInfo> GetList(string strWhere, string orderBy = null);
        ...
        List<MoodInfo> GetList(int currentPageIndex, int pageSize, out int totalCount, string strWhere, string orderBy);
