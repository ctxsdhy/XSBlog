<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyList.aspx.cs" Inherits="XS.Blog.WebUI.XSBlog.Daily.DailyList" MasterPageFile="../PageTemplates/BlogPageTemplate.master" %>
    ...
    <div class="daily">
        <div class="daily-list">
            ...
            <div class="daily-list-page">
                <webdiyer:AspNetPager ID="pager" runat="server" HorizontalAlign="Center" EnableUrlRewriting="True" UrlRewritePattern="/xsblog/%BlogName%/daily/c/%Category%/{0}" />
            </div>
        </div>
        <div class="clear"></div>
    </div>
