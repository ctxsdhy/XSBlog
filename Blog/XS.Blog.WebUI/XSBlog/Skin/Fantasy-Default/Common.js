var miu_scroll = {
     drawCircle: function(c, n, e) {
         ...
         var h = null;
         var b = Math.PI * 2;
         var a = Math.PI / 2; l.clearRect(0, 0, d, k);
     ...
     scrollHook: function(b, a) {
         ...
         b.scroll(function() {
             ...
             if (e.length > 0) {
                 ...
                 miu_scroll.drawCircle("#backtoTopCanvas", c, a);
             }
         });
     }
};
...
jQuery(document).ready(function() {
    if (jQuery(document).width() > 799) {
        jQuery("body").append('<div id="backtoTop" data-action="gototop"><canvas id="backtoTopCanvas" width="48" height="48"></canvas><div class="per"><i class="icon-angle-up"></i></div></div>');
        var a = miu_scroll;
        a.backToTop(jQuery("#backtoTop"));
        a.scrollHook(jQuery(window), "#6FAED9");
    }
});
